            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="contact" name="contact" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            ...
                            <input type="text" name="domain" id="domain" class="focus:ring-teal-500 focus:border-teal-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="www.raindesign.ee" />
                        </div>
                            <div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <input type="hours" name="price" id="price" class="w-12 text-right shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300 rounded-md" placeholder="25"/>h
                                </td>
                                <td class="py-4 px-3 text-right text-sm text-gray-500 sm:table-cell">
                                ...
                                <input type="total" name="price" id="price" class=" w-20 text-right shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300 rounded-md" placeholder="40.00"/>€
                                </td>
                            </tr>
                            </tbody>
                </table>
      ...
      <table class="min-w-full divide-y divide-gray-300">
        <tfoot>
          <tr>
           ...
           <tr>
            ...
            <input type="price" name="price" id="price" class=" w-12 text-right shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300 rounded-md" placeholder="50"/>%</td>
          </tr>
          <tr>
        ...
        <div class="sm:flex sm:items-center py-10">
            <div class="sm:flex-auto">
                ...
                <input type="weeks-1" name="weeks-1" id="price" class=" w-12 text-right shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300 rounded-md" placeholder="12"/>-
                <input type="weeks-2" name="weeks-2" id="price" class=" w-12 text-left shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm border-gray-300 rounded-md" placeholder="16"/>töönädalat.</p>
            ...
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <button type="button" name="download" class="inline-flex items-center justify-center rounded-md border border-transparent bg-teal-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">Lae alla</button>
            </div>
        </div>
        </div>
    </div>
